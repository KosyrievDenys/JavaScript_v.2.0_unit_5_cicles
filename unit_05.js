...
function t1() {
	...
	document.querySelector('.out-1').textContent = task1;
}
...
function t2() {
	...
	document.querySelector('.out-2').textContent = task2;
}
...
function t3() {
	...
	document.querySelector('.out-3').textContent = task3;
}
...
function t4() {
	...
	document.querySelector('.out-4').textContent = task4;
}
...
function t5() {
	...
	document.querySelector('.out-5').textContent = task5;
}
